...
* **Create a combined key for reference:** The script still creates a `combined_id` field by concatenating the normalized company, domain and phone columns. This is mainly for auditing and later steps.
